    ...
    return (
        <div className='footer'>
            <div className="container">
                <div className="footer__grid grid grid__col-3">
                    <div className="footer__col d-flex flex-column justify-between align-between">
                    ...
                    <div className="footer__col d-flex flex-column">
                        <p className="footer__title">Quick Link</p>
                        <Link className='footer__link' to=''>О себе</Link>
                        <Link className='footer__link' to='/#cons'>Консультации</Link>
                        <Link className='footer__link' to='/#edu'>Обучение</Link>
                        <Link className='footer__link' to=''>Контакты</Link>
                        <Link className='footer__link' to=''>Закрытый клуб</Link>

                    </div>

                    <div className="footer__col d-flex flex-column">
                        <p className="footer__title">For questions</p>

                        <NavLink className='footer__link' to='https://web.telegram.org/k/#@Kostas89' target='_blank'>Telegram: @Kostas89</NavLink>
                        <NavLink className='footer__link' to='https://web.telegram.org/k/#@zudiloff' target='_blank'>Telegram channel @zudiloff</NavLink>

                    </div>

                    <div className="footer__col d-flex flex-column">
                        <p className="footer__title-lg">Contact Us</p>
                        <div className="footer__icons">
                            ...
                            <i className="footer__icon fa-brands fa-twitter"></i>
                            <i className="footer__icon fa-brands fa-linkedin"></i>
                        </div>
                    ...
                    <p className="footer__link">©2023 ZUDILOFF. All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
